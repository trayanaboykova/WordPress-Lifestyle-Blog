            ...
            <nav class="s-header__nav-wrap">
                ...
                <ul class="s-header__nav">
                    ...
                    <li class="has-children">
                        ...
                        <ul class="sub-menu">
                            <li class="current-menu-item"><a href="<?php echo home_url( '/?post_type=post' ); ?>"
                                                             title="">All Posts</a></li>
							<?php
							$authors = get_users();
							foreach ( $authors as $author ) :
								?>
                                <li><a href="<?php echo get_author_posts_url( $author->ID ); ?>"
                                       title="Posts by <?php echo esc_html( $author->display_name ); ?>">Posts
                                        by <?php echo esc_html( $author->display_name ); ?></a></li>
							<?php endforeach; ?>
							<?php
							global $wpdb;
							...
							foreach ( $years as $year ) :
								?>
                                <li><a href="<?php echo get_year_link( $year->year ); ?>"
                                       title="Posts from <?php echo $year->year; ?>">Posts
                                        from <?php echo $year->year; ?></a></li>
							<?php endforeach; ?>
                        </ul>
                    </li>
