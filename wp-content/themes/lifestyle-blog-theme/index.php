                    ...
                    <article class="brick entry" data-animate-el>
                        ...
                        <div class="entry__text">
                            <div class="entry__header">
                                ...
                                <h1 class="entry__title"><a href="single-standard.php">Just a Normal Simple Blog Post.</a></h1>
                            </div>
                    ...
                    <article class="brick entry" data-animate-el>
                        ...
                        <div class="entry__text">
                            <div class="entry__header">
                                ...
                                <h1 class="entry__title"><a href="single-standard.php">5  Grayscale Coloring Techniques.</a></h1>
                            </div>
                            <div class="entry__excerpt">
                                <p>
                    ...
                    <article class="brick entry" data-animate-el>
                        ...
                        <div class="entry__text">
                            <div class="entry__header">
                                ...
                                <h1 class="entry__title"><a href="single-standard.php">What Minimalism Really Looks Like.</a></h1>
                            </div>
                            <div class="entry__excerpt">
                                <p>
                    ...
                    <article class="brick entry" data-animate-el>
                        ...
                        <div class="entry__text">
                            <div class="entry__header">
                                ...
                                <h1 class="entry__title"><a href="single-standard.php">Red and Blue Photo Effects.</a></h1>
                            </div>
                            <div class="entry__excerpt">
                                <p>
                                    Lorem ipsum Sed eiusmod esse aliqua sed incididunt aliqua incididunt mollit id et sit proident dolor nulla sed commodo
                    ...
                    <article class="brick entry" data-animate-el>
                        ...
                        <div class="entry__text">
                            <div class="entry__header">
                                ...
                                <h1 class="entry__title"><a href="single-standard.php">10 Practical Ways to Be Minimalist.</a></h1>
                            </div>
                            <div class="entry__excerpt">
                                <p>
                    ...
                    <article class="brick entry" data-animate-el>
                        ...
                        <div class="entry__text">
                            <div class="entry__header">
                                ...
                                <h1 class="entry__title"><a href="single-standard.php">What Does Reading Do to Your Brain?</a></h1>
                            </div>
                            <div class="entry__excerpt">
                                <p>
                    ...
                    <article class="brick entry" data-animate-el>
                        ...
                        <div class="entry__text">
                            <div class="entry__header">
                                ...
                                <h1 class="entry__title"><a href="single-standard.php">Symmetry In Modern Design.</a></h1>
                            </div>
                            <div class="entry__excerpt">
                                <p>
                    ...
                    <article class="brick entry" data-animate-el>
                        ...
                        <div class="entry__text">
                            <div class="entry__header">
                                ...
                                <h1 class="entry__title"><a href="single-standard.php">10 Tips for Managing Time Effectively.</a></h1>
                            </div>
                            <div class="entry__excerpt">
                                <p>
                                    Lorem ipsum Sed eiusmod esse aliqua sed incididunt aliqua incididunt mollit id et sit proident dolor nulla
                    ...
                    <article class="brick entry" data-animate-el>
                        ...
                        <div class="entry__text">
                            <div class="entry__header">
                                ...
                                <h1 class="entry__title"><a href="single-standard.php">Black And White Photography Tips.</a></h1>
                            </div>
                            <div class="entry__excerpt">
                                <p>
